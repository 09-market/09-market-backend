...
public class ItemDetailDto {
    ...
    public ItemDetailDto(Long itemId, String itemImageUrl, String name, String itemInfo, Integer price, Integer amount, String category, String instagramUrl, int likes, List<Comment> comments, Long userId, String userImageUrl, String nickname) {
        this.itemId = itemId;
